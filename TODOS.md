...
- ~~**Disk-cleanup-script**~~ KLAR 2026-04-24. `scripts/cleanup-docker.sh` tar bort oanvända images äldre än 7 dagar + stoppade containers + build-cache + oanvända nätverk. Volymer rörs aldrig. Cron-förslag dokumenterat i RELEASE.md. **Kvar:** installera cron på VPS:n (söndag 04:00).
