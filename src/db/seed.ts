  ...
  const activityDefs = [
    {
      ...
      minAge: null,
      tags: ["Vandring"],
      whatToExpect: { okAlone: true, experienceLevel: "alla", whoComes: "Blandad grupp, alla åldrar", latePolicy: "Kom i tid, vi väntar inte efter start", courageMessage: "Du behöver inte känna någon för att komma — många som dyker upp gör det för första gången." },
    },
    {
      ...
      minAge: null,
      tags: ["Brädspel"],
      whatToExpect: { okAlone: true, experienceLevel: "alla", whoComes: "Mest 20-40 år, alla välkomna", latePolicy: "Kom när du kan, vi kör hela kvällen", courageMessage: "Kom som du är. Det spelar ingen roll om du är nybörjare eller inte känner någon." },
    },
    {
      ...
      minAge: null,
      tags: ["Matlagning"],
      whatToExpect: { okAlone: true, experienceLevel: "nybörjare", whoComes: "Matintresserade i alla åldrar", latePolicy: "Kom i tid, vi börjar laga direkt", courageMessage: "Alla är välkomna oavsett erfarenhet. Vi ses där!" },
    },
    {
    ...
    },
    {
      ...
      minAge: null,
      tags: ["Yoga"],
      whatToExpect: { okAlone: true, experienceLevel: "nybörjare", whoComes: "Mest kvinnor 25-50, men alla välkomna", latePolicy: "Kom 5 min innan start", courageMessage: "Jag startade den här aktiviteten just för att det ska vara lätt att hänga med — välkommen!" },
    },
    {
